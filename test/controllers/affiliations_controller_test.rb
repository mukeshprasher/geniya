...
class AffiliationsControllerTest < ActionController::TestCase
  ...
  test "should create affiliation" do
    assert_difference('Affiliation.count') do
      post :create, affiliation: { end_date: @affiliation.end_date, organization_id: @affiliation.organization_id, start_date: @affiliation.start_date, status: @affiliation.status, sub_category_id: @affiliation.sub_category_id, user_id: @affiliation.user_id }
    end
  ...
  test "should update affiliation" do
    patch :update, id: @affiliation, affiliation: { end_date: @affiliation.end_date, organization_id: @affiliation.organization_id, start_date: @affiliation.start_date, status: @affiliation.status, sub_category_id: @affiliation.sub_category_id, user_id: @affiliation.user_id }
    assert_redirected_to affiliation_path(assigns(:affiliation))
  end
