...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { address: @advertisement.address, contact: @advertisement.contact, name: @advertisement.name }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { address: @advertisement.address, contact: @advertisement.contact, name: @advertisement.name }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
