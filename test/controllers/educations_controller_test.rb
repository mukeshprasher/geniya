...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { course: @education.course, end: @education.end, institute: @education.institute, start: @education.start }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { course: @education.course, end: @education.end, institute: @education.institute, start: @education.start }
    assert_redirected_to education_path(assigns(:education))
  end
