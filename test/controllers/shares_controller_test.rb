...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { comment: @share.comment, shared_id: @share.shared_id, shared_type: @share.shared_type, user_id: @share.user_id }
    end
  ...
  test "should update share" do
    patch :update, id: @share, share: { comment: @share.comment, shared_id: @share.shared_id, shared_type: @share.shared_type, user_id: @share.user_id }
    assert_redirected_to share_path(assigns(:share))
  end
