...
class MenuitemsControllerTest < ActionController::TestCase
  ...
  test "should create menuitem" do
    assert_difference('Menuitem.count') do
      post :create, menuitem: { description: @menuitem.description, name: @menuitem.name, price: @menuitem.price }
    end
  ...
  test "should update menuitem" do
    patch :update, id: @menuitem, menuitem: { description: @menuitem.description, name: @menuitem.name, price: @menuitem.price }
    assert_redirected_to menuitem_path(assigns(:menuitem))
  end
