class Upload < ActiveRecord::Base
  ...
  has_attached_file :file_attachment, :styles => { :medium => "300x300>", :thumb => "400x400>" }, :default_url => "/assets/missing.png", :hash_secret => "geniyaAttach", :path => ":rails_root/public/system/uploads/:id_:style.:extension", :url => "/system/uploads/:id_:style.:extension"
